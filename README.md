...
```bash
DisneyScrap$ sam logs -n StockCheckerFunction --stack-name DisneyScrap --tail
```
...
```bash
DisneyScrap$ cd functions/stock-checker
...
```bash
sam delete --stack-name DisneyScrap
```
